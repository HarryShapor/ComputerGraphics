...
class ShowLabel extends JLabel {
    ...
    ShowLabel() {
        image = Toolkit.getDefaultToolkit().getImage("src/images/sa.jpg");
    ...
    public void createImages() {
        ...
        bufferedImage2 = new BufferedImage(image.getWidth(this), image.getHeight(this), BufferedImage.TYPE_INT_RGB);
    }
