...
//Вычисляем яркость точки
        int grayColor = (int)(0.33 * g + 0.33 * r + 0.33 * b);
//Получаем цвет точки в оттенках серого такой же яркости, как яркость исходной точки int grayColor = (int) (0xff000000 | gray << 16 | gray << 8 | gray);
        return grayColor;
    }
}
